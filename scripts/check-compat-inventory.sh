...
run_report_generator "$ROOT/scripts/generate-phase0-upstream-source-pointer-report.sh"
...
require_file "$FIXTURE_DIR/migration/phase0_upstream_source_pointers.md"
