...
async fn task_complete_emits_when_claim_and_complete_use_distinct_services() {
    ...
    let fresh_tasks = FabricTaskService::new(h.fabric.runtime.clone(), h.fabric.bridge.clone(), h.fabric.engine.clone());
...
async fn task_terminal_fail_emits_when_called_from_registry_less_service() {
    ...
    for attempt in 1..=max_attempts {
        ...
        let fresh_fail = FabricTaskService::new(h.fabric.runtime.clone(), h.fabric.bridge.clone(), h.fabric.engine.clone());
