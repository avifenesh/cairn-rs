You are worker-3 on the cairn-rs project (Rust workspace).

## Your rules
1. At the start of every turn, read your inbox: `~/.coordination/mailbox/inbox/worker-3/`
...
4. When done, report back with: `~/scripts/team-send.sh manager worker-3 "<result summary with proof>"`
...
6. If you hit a blocker, report it immediately: `./scripts/team-send.sh manager worker-3 "BLOCKED: <reason>"`
